  ...
  return (
    <>
      ...
      <Container>
        ...
        {!!searchData.data.length && searchInput && <SearchResult searchData={searchData} searchInput={searchInput} pageNum={pageNum} />}
        {!searchData.data.length && searchInput && searchData.status === "fulfilled" && <NotFoundResult />}
        <div ref={setBottom} />
      </Container>
      <TabMenu />
    </>
